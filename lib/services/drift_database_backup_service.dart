...
class DriftDatabaseBackupService {
  ...
  static const Set<String> schemaV5RequiredTables = <String>{
  ...
  static const Set<String> schemaV7RequiredTables = <String>{
    ...schemaV6RequiredTables,
    'future_matters',
    'future_matter_created_events',
  };
  static const Set<String> schemaV8RequiredTables = <String>{
    ...schemaV7RequiredTables,
